...
public class StepDefinitions {
    ...
    public void se_devuelve_un_empleado_cuya_propriedad_nombre_esta_compuesta_por_caracteres_alfabeticos()
            throws Exception {
        JSONObject json = new JSONObject(response.body().asString());
    ...
    public void se_devuelve_un_empleado_cuya_propriedad_apellido_esta_compuesta_por_caracteres_alfabeticos()
            throws Exception {
        JSONObject json = new JSONObject(response.body().asString());
